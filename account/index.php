...
<?php ob_start(); ?>
<?php
	$__server->page_embeds->page_title = "LeytiTube - Broadcast Something.";
	$__server->page_embeds->page_description = "Share your videos with friends, family, and the world";
	$__server->page_embeds->page_url = "https://leyti.xyz/";
?>
<!DOCTYPE html>
                                ...
                                <div style="margin-top:10px;">
                                    ...
                                    <div style="margin-top:20px;display:flex;flex-direction:row;white-space:nowrap;">
                                        ...
                                        <div style="display:flex;flex-direction:column">
                                            ...
                                            <p style="margin-top:5px;color:grey;">You will be redirected to your Leyti+ account page</p>
                                        </div>
                                    </div>
                                    <div style="margin-top:20px;display:flex;flex-direction:row;white-space:nowrap;">
                                        <div style="width:30%;">
