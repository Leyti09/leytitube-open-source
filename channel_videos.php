...
<?php
	...
	while($ban = $stmt->fetch(PDO::FETCH_ASSOC)) { 
		header("Location: /?error=This user has been terminated for violating LeytiTube's Community Guidelines.");
	}
...
?>
<?php
	$__server->page_embeds->page_title = "LeytiTube - " . htmlspecialchars($_user['username']);
                                    ...
                                    <div class="tab-content-body">
                                        <div class="channel-filtered-page">
                                            <div class="channel-filtered-page-head">
												...
												<button type="button" class="video-sort-btn yt-uix-button yt-uix-button-default" onclick=";return false;" role="button" aria-pressed="false" aria-expanded="false" aria-haspopup="true" aria-activedescendant=""><span class="yt-uix-button-content">Date added (newest - oldest) </span><img class="yt-uix-button-arrow" src="//web.archive.org/web/20120727095249im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt=""><ul class=" yt-uix-button-menu yt-uix-button-menu-default" role="menu" aria-haspopup="true" style="display: none;"><li role="menuitem" id="aria-id-45372135652"><span href="/user//videos?sort=p&amp;view=0" class=" yt-uix-button-menu-item" onclick=";window.location.href=this.getAttribute('href');return false;">Most popular</span></li><li role="menuitem" id="aria-id-8390683708"><span href="/user//videos?sort=da&amp;view=0" class=" yt-uix-button-menu-item" onclick=";window.location.href=this.getAttribute('href');return false;">Date added (oldest - newest)</span></li><li role="menuitem" id="aria-id-58322133044"><span href="/user//videos?sort=dd&amp;view=0" class=" yt-uix-button-menu-item" onclick=";window.location.href=this.getAttribute('href');return false;">Date added (newest - oldest)</span></li></ul></button>
