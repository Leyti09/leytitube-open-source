...
<div id="footer">
    ...
    <div id="footer-logo">
      <a href="" title="LeytiTube home">
        <img src="http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="YouTube home">
      </a>
  ...
  <div id="in-product-help" class="yt-uix-clickcard">
    <button type="button" id="help-button" onclick=";return false;" class="yt-uix-clickcard-target yt-uix-button-reverse yt-uix-button yt-uix-button-default" data-orientation="vertical" data-locale="en_US" data-iph-anchor-text="More Help" data-iph-search-button-text="Search" data-iph-tracking="iph-questionmark" data-iph-js-url="//s.ytimg.com/yt/jsbin/www-help-vflwAbmtR.js" data-iph-search-input-text="Search YouTube's Help Center" data-iph-title-text="Need Help on this page?" data-iph-topic-id="1699712" data-iph-css-url="//s.ytimg.com/yt/cssbin/www-helpie-vfl57o1j6.css" data-help-center-host="//support.google.com/youtube" role="button"><span class="yt-uix-button-content">  <img class="questionmark" src="/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif">
  <span>Help</span>
  <img class="yt-uix-button-arrow" src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif">
 </span></button>
    <div class="yt-uix-clickcard-content" id="help-target">  <p class="loading-spinner">
    <img src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="">
Loading...
  </p>
</div>
  </div>
      ...
      <ul id="footer-links-primary">
        <li><a href="/t/about_leytitube">About</a></li>
      ...
      <ul id="footer-links-secondary">
        ...
        <li><a href="//web.archive.org/web/20120729062021/http://support.google.com/youtube/bin/request.py?contact_type=abuse&amp;hl=en-US">Safety</a></li>
...
Language:
  ...
  <button type="button" class=" yt-uix-button yt-uix-button-text" onclick=";return false;" data-button-toggle="true" data-picker-position="footer" data-button-menu-id="arrow-display" data-picker-key="language" data-button-action="yt.www.picker.load" role="button"><span class="yt-uix-button-content">English </span><img class="yt-uix-button-arrow" src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt=""></button>
...
Location:
  ...
  <button type="button" class=" yt-uix-button yt-uix-button-text" onclick=";return false;" data-button-toggle="true" data-picker-position="footer" data-button-menu-id="arrow-display" data-picker-key="country" data-button-action="yt.www.picker.load" role="button"><span class="yt-uix-button-content">Worldwide </span><img class="yt-uix-button-arrow" src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt=""></button>
...
Safety:
  ...
  <button type="button" class=" yt-uix-button yt-uix-button-text" onclick=";return false;" data-button-toggle="true" data-picker-position="footer" data-button-menu-id="arrow-display" data-picker-key="safetymode" data-button-action="yt.www.picker.load" role="button"><span class="yt-uix-button-content">Off
 </span><img class="yt-uix-button-arrow" src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt=""></button>
      ...
      <p class="yt-spinner">
    <img src="//web.archive.org/web/20120729062021im_/http://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" class="yt-spinner-img" alt="">
Loading...
  </p>
