			...
			<div id="content-container">
				...
				<?php
					if(empty(trim($_user['bio'])))
						$_user['bio'] = "No description available.";
				?>
				<div id="content">
										...
										<div class="upper-section clearfix">
											...
											<div class="upper-left-section enable-fancy-subscribe-button">
												...
												<?php if($__user_h->if_partner($_user['username'])) { ?>
													<img style="width: 29px;vertical-align: middle;margin-left: 10px;" title="This user is a LeytiTube partner" src="/yt/imgbin/RenderedImage.png">
												<?php } ?>
											</div>
											<div class="upper-right-section">
												<div class="header-stats">
													<div class="stat-entry">
														...
														<span class="stat-name"><?php if($_user['subscribers'] == 1){ ?>subscribers<?php }else{ ?>subscribers<?php } ?></span>
													</div>
													<div class="stat-entry">
